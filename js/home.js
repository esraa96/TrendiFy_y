...
function getDataFromDB() {
    ...
    { id: 128, name: "baby Gitl Dress", price: 800.0, description: "Main Fabric Content : Polyurethane 100%.", images: ["./images/baby.jpeg"] },
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    categories.forEach(category => {
        ...
        link.href = "category.html?category_id=" + category.category_id;
...
window.addEventListener("load", function() {
    loadHiyawanSlides();
    document.getElementById("hiyawanPrevBtn").addEventListener("click", prevHiyawanSlide);
    document.getElementById("hiyawanNextBtn").addEventListener("click", nextHiyawanSlide);
});

function loadHiyawanSlides() {
    var hiyawanSlider = document.getElementById("hiyawanSlider");
    hiyawanSlider.innerHTML = "";
    hiyawanData.forEach(function(item) {
        var slide = document.createElement("div");
        slide.classList.add("hiyawan-slide");
        var card = document.createElement("div");
        card.classList.add("hiyawan-card");
        var img = document.createElement("img");
        img.src = item.url;
        ...
        hiyawanSlider.appendChild(slide);
    });
}

function nextHiyawanSlide() {
    if (hiyawanIndex < hiyawanData.length - 4) {
        hiyawanIndex++;
    } else {
        hiyawanIndex = 0;
    }
...
function prevHiyawanSlide() {
    if (hiyawanIndex > 0) {
        hiyawanIndex--;
    } else {
        hiyawanIndex = hiyawanData.length - 4;
    }
    updateHiyawanSlider();
}

function updateHiyawanSlider() {
    document.getElementById("hiyawanSlider").style.transform = "translateX(-" + (hiyawanIndex * 25) + "%)";
}
/////////////////
